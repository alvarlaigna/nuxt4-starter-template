...
export default defineNuxtConfig({
  ...
  modules: [
    ...
    ["nuxt-security", {
      headers: {
        crossOriginEmbedderPolicy: process.env.NODE_ENV === 'development' ? false : 'require-corp',
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'description', content: 'A modern Nuxt 4 starter template with best practices and optimizations built-in' },
        { name: 'theme-color', content: '#00DC82' },
        { property: 'og:type', content: 'website' },
        { property: 'og:title', content: 'Nuxt 4 Starter Template' },
        { property: 'og:description', content: 'A modern Nuxt 4 starter template with best practices and optimizations built-in' },
